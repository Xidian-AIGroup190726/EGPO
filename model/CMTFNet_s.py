...
class MutilScal(nn.Module):
    def __init__(self, dim=256, fc_ratio=4, dilation=[3, 5, 7], pool_ratio=16):
...
class Block(nn.Module):
    def __init__(self, dim=256, num_heads=16,  mlp_ratio=4, pool_ratio=16, drop=0., dilation=[3, 5, 7],
...
class CMTFNet(nn.Module):
    def __init__(self,
        ...
        self.decoder = Decoder(encode_channels, decode_channels, dropout=dropout, num_classes=classes)
